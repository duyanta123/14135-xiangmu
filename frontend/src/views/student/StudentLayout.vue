  ...
  <div class="layout-root">
    ...
    <aside :class="['sidebar', { open: sidebarOpen }]">
      ...
      <nav class="sidebar-nav">
        <router-link to="/student/course" class="nav-item" active-class="active" @click="sidebarOpen = false">
          <span class="nav-icon">📋</span>
          <span>课程列表</span>
        </router-link>
        <router-link to="/student/my-course" class="nav-item" active-class="active" @click="sidebarOpen = false">
          <span class="nav-icon">📚</span>
          <span>我的课程</span>
        </router-link>
        <router-link to="/student/schedule" class="nav-item" active-class="active" @click="sidebarOpen = false">
          <span class="nav-icon">📅</span>
          <span>我的课表</span>
        </router-link>
        <router-link to="/student/attendance" class="nav-item" active-class="active" @click="sidebarOpen = false">
          <span class="nav-icon">📝</span>
          <span>课堂签到</span>
        </router-link>
        <router-link to="/student/attendance-history" class="nav-item" active-class="active" @click="sidebarOpen = false">
          <span class="nav-icon">📊</span>
          <span>考勤记录</span>
        </router-link>
      </nav>
    ...
    <main class="main-area">
      ...
      <div class="mobile-topbar">
        ...
        <span class="topbar-title">学生端</span>
      </div>
